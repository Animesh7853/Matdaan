...
console.log('token')
  ...
  const handleVoteSubmission =  async () => {
   ...
   const response = await  fetch('https://matdaan-1.onrender.com/voter/cast-vote/MUNICIPAL', {
      method: 'POST',
      headers: {
  ...
  return (
    ...
    <h2>Candidates List for MUNICIPAL Election</h2>
